...
window.onload = function() {
    ...
    $('formRegister').addEventListener('submit', function(event) {
        ...
        const elementsForm = this.elements; //propiedad elements accede a todos los elementos del formulario
        let error = false;
        ...
        !error && this.submit() // si no hay errores enviame el formulario
    })
